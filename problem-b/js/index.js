...
*/
let dateOfBirth = document.querySelector("#dobInput");
dateOfBirth.addEventListener('input', function() {
  let age = getYearsSince(dateOfBirth.value);
  if (age < 13 || age > 200) {
    dateOfBirth.setCustomValidity("You need to be at least 13 years old.");
...
function validatePasswordMatch() {
  ...
  let confirmInput = document.querySelector("#passwordConfirmInput");
